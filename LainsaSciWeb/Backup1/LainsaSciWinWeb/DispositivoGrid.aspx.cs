    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack) {
            if(RadGrid1.MasterTableView.SortExpressions.Count == 0) {
                ...
                expression.FieldName = "DispositivoId";
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Edit":
                    //RadAjaxManager1.ResponseScripts.Add("minimizeWindow();");
                   // RadAjaxManager1.ResponseScripts.Add("flip_flop();");
                    //RadWindowManager1.Behaviors = WindowBehaviors.Minimize;
                //RadAjaxManager1.ResponseScripts.Add("resizeWindow();"); //Esto añadi
