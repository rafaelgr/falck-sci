            ...
            <td></td>
              <td>
                    <div id="SustitucionId" style="padding: 5px;">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtSustitucionId" runat="server" Enabled="false" Width="150px"
                            TabIndex="1">
                        </telerik:RadTextBox>
                    </div>
                </td>
                <td>
                    <div id="Div1" class="normalText" style="padding: 5px;">
                        <asp:Label ID="Label1" runat="server" Text="Fecha reposición:"></asp:Label>
                        <br />
                        <telerik:RadDatePicker ID="invData" runat="server" Width="150px" TabIndex="71">
                            <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                FastNavigationStep="12">
                            </Calendar>
                            <DateInput DisplayDateFormat="d/MM/yyyy" DateFormat="d/MM/yyyy" TabIndex="71">
                            </DateInput>
                            <DatePopupButton ImageUrl="" HoverImageUrl="" TabIndex="71"></DatePopupButton>
