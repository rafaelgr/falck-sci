...
public partial class DispositivoForm : System.Web.UI.Page
{
    ...
    protected void btnAccept_Click(object sender, ImageClickEventArgs e)
    {
        ...
        //{
            ...
            if(!dispositivo.Operativo && !dispositivo.SiguePlan && !dispositivo.Caducado)
            {
    ...
    protected void UnloadData(Dispositivo dispositivo)
    {
        ...
        if (dispositivo.Operativo) dispositivo.SiguePlan = true;
    }
    ...
    protected void CargarFabricantes(int id)
    {
        ...
        foreach (Fabricante f in CntLainsaSci.GetFabricantes(usuario,ctx))
        {
    ...
    protected void CargarAgentesExtintores(int id)
    {
        ...
        foreach (AgenteExtintor ae in CntLainsaSci.GetAgenteExtintors(usuario,ctx))
        {
    ...
    protected void chkOperativo_CheckedChanged(object sender, EventArgs e)
    {
        // controlar el indicador de planificaciones.
        chkSiguePlan.Visible = !chkOperativo.Checked;
    }
    ...
    protected void CargarFabricantes(Empresa e) {
        rdcFabricante.Items.Clear();
        foreach(Fabricante f in CntLainsaSci.GetFabricantes(usuario, ctx)) {
            if(f.Empresa == null || f.Empresa.EmpresaId == e.EmpresaId) {
                rdcFabricante.Items.Add(new RadComboBoxItem(f.Nombre, f.FabricanteId.ToString()));
            }
        }
        rdcFabricante.Items.Add(new RadComboBoxItem(" ", ""));
    ...
    protected void CargarAgentesExtintores(Empresa e) {
        rdcAgenteExtintor.Items.Clear();
        foreach(AgenteExtintor ae in CntLainsaSci.GetAgenteExtintors(usuario, ctx)) {
            if(ae.Empresa == null || ae.Empresa.EmpresaId == e.EmpresaId) {
                rdcAgenteExtintor.Items.Add(new RadComboBoxItem(ae.Descripcion, ae.AgenteExtintorId.ToString()));
            }
        }
        rdcAgenteExtintor.Items.Add(new RadComboBoxItem(" ", ""));
