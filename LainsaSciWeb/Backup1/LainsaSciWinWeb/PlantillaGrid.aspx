<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantillaGrid.aspx.cs" Inherits="PlantillaGrid" %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newUsuario");
              var url = "PlantillaForm.aspx?Caller=PlantillaGrid";
              var name = "PlantillaForm";
              openOutSide(url, name);
          }
          function editPlantilla(id)
          {
              var url = "PlantillaForm.aspx?Caller=PlantillaGrid" + "&PlantillaId=" + id;
              var name = "PlantillaForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="PlantillaId" 
                                         FilterControlToolTip="Filtrar por PlantillaId" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="PlantillaId" UniqueName="PlantillaId">
...
<%--                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newPlantilla();" 
