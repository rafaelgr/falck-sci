<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgenteExtintorForm.aspx.cs" Inherits="AgenteExtintorForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td >
              <div id="AgenteExtintorId" style="padding:5px;">
                <asp:Label ID="lblAgenteExtintorId" runat="server" Text="ID"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtAgenteExtintorId" runat="server" Enabled="false" Width="100%" TabIndex="1">
                </telerik:RadTextBox>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td >
              <div id="AgenteExtintorNombre" style="padding:5px;">
