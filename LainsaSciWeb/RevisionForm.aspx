...
<body>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function newRevision() {
                var url = "RevisionNoPeriodica.aspx?Caller=DispositivoTab&DispositivoId=" + "<%=this.dispositivo.DispositivoId%>";
    ...
    <div id="MainArea" class="normalText">
            ...
            <tr>
                <td>
                    <div id="RevisionId" style="padding: 5px;">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtRevisionId" runat="server" Enabled="false" Width="100%"
                            TabIndex="1">
                        </telerik:RadTextBox>
                    </div>
                </td>
                ...
                <td>
                    <div id="FechaProgramada">
                        ...
                        <telerik:RadDatePicker ID="rdpFechaProgramada" runat="server" Enabled="false" TabIndex="3">
                            ...
                            <DateInput DisplayDateFormat="dd/MM/yyyy" DateFormat="dd/MM/yyyy" TabIndex="3">
                            </DateInput>
                            <DatePopupButton CssClass="rcCalPopup rcDisabled" ImageUrl="" HoverImageUrl="" TabIndex="3">
                            </DatePopupButton>
                        </telerik:RadDatePicker>
                    </div>
                </td>
                <td>
                    <div id="Status">
                        ...
                        <asp:RequiredFieldValidator ID="valTxtStatus" runat="server" Display="Dynamic" ControlToValidate="txtStatus"
                            CssClass="normalTextRed" ErrorMessage="Se necesita un Estado de Revision">
            ...
            <tr>
                <td colspan="2">
                    <div id="Dispositivo" class="normalText" style="padding: 5px;">
                        <asp:Label ID="lblDispositivo" runat="server" Text="Dispositivo:" ToolTip="Dispositivo que se revisa"></asp:Label>
                        <br />
                        <telerik:RadTextBox ID="txtDispositivo" runat="server" Width="100%" Enabled="False">
                        </telerik:RadTextBox>
                    </div>
                </td>
                <td colspan="2">
                    <div id="Operario" class="normalText" style="padding: 5px;">
                        <asp:Label ID="lblOperario" runat="server" Text="Operario:" ToolTip="Operario que ha hecho la revisión"></asp:Label>
                        &nbsp;
                        <asp:ImageButton ID="imgbOperario" runat="server" CausesValidation="false" ImageUrl="~/images/search_mini.png"
                            OnClientClick="searchOperario('RevisionForm');" ToolTip="Haga clic aquí para buscar Operarios" />
                        <br />
                        <telerik:RadComboBox runat="server" ID="rdcOperario" TabIndex="4" Height="100px"
                            Width="300px" ItemsPerRequest="10" EnableLoadOnDemand="true" ShowMoreResultsBox="true"
                            EnableVirtualScrolling="true" EmptyMessage="Escriba aquí ..." AutoPostBack="True"
                            OnItemsRequested="rdcOperario_ItemsRequested" OnSelectedIndexChanged="rdcOperario_SelectedIndexChanged">
                        </telerik:RadComboBox>
                    </div>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <div id="FechaRevisión">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                            ControlToValidate="rdpFechaRevision" CssClass="normalTextRed" ErrorMessage="Se necesita la fecha en que se hizo la revisión">
                        </asp:RequiredFieldValidator>
                    </div>
                </td>
            </tr>
        ...
        <div id="PPlantilla" class="marcoPlantilla" style="padding: 5px">
            <asp:PlaceHolder ID="PlantillaHolder" runat="server"></asp:PlaceHolder>
        </div>
        <table style="width: 100%">
            <tr>
                <td colspan="3">
                    <div id="Resultado" style="padding: 5px;">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtResultado" runat="server" Width="100%" TabIndex="5" MaxLength="255"
                            TextMode="MultiLine">
                        </telerik:RadTextBox>
                        <br />
                        <asp:RequiredFieldValidator ID="valResultado" runat="server" Display="Dynamic" ControlToValidate="txtResultado"
                            CssClass="normalTextRed" ErrorMessage="Se necesita un resultado para la Revisión">
                        </asp:RequiredFieldValidator>
                    </div>
                </td>
                <td colspan="1">
                    <div id="TipoAnomalia">
                        <asp:Label ID="lblTipoAnomalia" runat="server" Text="Tipo de anomalía detectada"></asp:Label>
                        <br />
                        <telerik:RadComboBox ID="rdcTipoAnomalia" runat="server" Width="200px">
                        </telerik:RadComboBox>
                        <br />
                    </div>
                </td>
            ...
            <tr>
                <td colspan="4">
                    <div id="Observaciones" style="padding: 5px;">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtObservaciones" runat="server" Width="100%" TabIndex="6"
            ...
            <tr>
                <td colspan="4">
                    <div id="Buttons" class="buttonsFormat">
                        ...
                        <asp:ImageButton ID="btnPlanificar" runat="server" CausesValidation="false" ImageUrl="~/images/magic-wand.png"
                            ToolTip="Planificar revisiones" TabIndex="6" Height="25px"
                            Width="28px" OnClick="btnPlanificar_Click" Visible="False" />
                        <asp:ImageButton ID="btnIncidencia" runat="server" CausesValidation="false" ImageUrl="~/images/warning_32.png"
                            ToolTip="Incidencias asociadas" TabIndex="6" OnClick="btnIncidencia_Click" Height="25px"
                            Width="28px" />
                        &nbsp;
                        <asp:ImageButton ID="btnSustitucion" runat="server" CausesValidation="false" ImageUrl="~/images/gear_refresh.png"
                            ToolTip="Sustituciones asociadas" TabIndex="6" OnClick="btnSustitucion_Click" />
                        &nbsp;
                        <asp:ImageButton ID="btnAccept" runat="server" ImageUrl="~/images/document_ok.png"
                            OnClick="btnAccept_Click" ToolTip="Guardar y salir" TabIndex="6" />
                        &nbsp;
