...
public partial class ModeloForm : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                rdcEmpresa.Items.Clear();
                foreach(string key in lstEmp.Keys) { 
                    rdcEmpresa.Items.Add(new RadComboBoxItem(lstEmp[key].Key, key));
                }
            ...
            {
                rdcInstalacion.Items.Clear();
                foreach(string key in lstInst.Keys) {
                    rdcInstalacion.Items.Add(new RadComboBoxItem(lstInst[key], key));
    ...
    protected void LoadData(ModeloDispositivo modelo)
    {
        ...
        if (modelo.Empresa != null && modelo.Instalacion == null)
        {
            rdcInstalacion.Items.Clear();
            foreach (Instalacion inst in modelo.Empresa.Instalaciones)
                rdcInstalacion.Items.Add(new RadComboBoxItem(inst.Nombre, inst.InstalacionId.ToString()));
        }
        ...
        if (modelo.CargaKg != 0)
        {
            txtCargaKg.Value = (double)modelo.CargaKg;
        }
    }
