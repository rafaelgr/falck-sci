<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaRevisiones.aspx.cs" Inherits="ConsultaRevisiones" EnableEventValidation="true"%>
                        ...
                        <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="None"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Dispositivo.NumeroIndustria" 
                                                         ...
                                                         HeaderText="Numero industria" 
                                                         ReadOnly="True" 
                                                         SortExpression="Dispositivo.NumeroIndustria" 
                                                         UniqueName="NumeroIndustria">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="Dispositivo.ModeloDispositivo.Nombre" 
                                                         FilterControlToolTip="Filtrar por modelo de dispositivo" FilterImageToolTip="Filtro"
                                                         HeaderText="Modelo dispositivo" 
                                                         ReadOnly="True" 
