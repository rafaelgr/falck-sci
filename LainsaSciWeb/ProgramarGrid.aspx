                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblPagina" runat="server" Text="Registros por página:"></asp:Label>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtPagina" runat="server" DataType="System.Int32" MinValue="5" Value="10" Width="50px">
                            ...
                            <td>
                                <asp:Button ID="btnPagina" runat="server" Text="Cambiar paginación" OnClick="btnPagina_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server"
                        ...
                        <MasterTableView ClientDataKeyNames="RevisionId" AutoGenerateColumns="False" CommandItemDisplay="TopAndBottom"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Dispositivo.CodBarras" 
