...
public partial class InstalacionGrid : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridCommandItem)
        {
            ...
            if (empresa != null)
            {
                img.OnClientClick = String.Format("newInstalacionFromEmpresa('{0}');", empresa.EmpresaId);
            }
            bool isAdmin = false;
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string strKey = item.GetDataKeyValue("InstalacionId").ToString();
            ...
            jCommand = String.Format("returnValues3('{0}','{1}','{2}');", strKey, item["Nombre"].Text,"Instalacion");
            ...
            jCommand = String.Format("editInstalacion({0});", strKey);
            if (empresa != null)
                jCommand = String.Format("editInstalacionFromEmpresa({0});", strKey);
            imgb.OnClientClick = jCommand;
