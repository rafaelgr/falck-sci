...
<body>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" OnClientCommand="OnClientCommand"
        ...
        <Windows>
            ...
            <telerik:RadWindow ID="AgenteExtintorForm" runat="server" Title="Agente extintor"
                NavigateUrl="AgenteExtintorForm.aspx" Height="300px" Width="450px" MaxHeight="768px"
                MaxWidth="1024px" KeepInScreenBounds="false" RestrictionZoneID="AreaVentanas">
            </telerik:RadWindow>
            ...
            <telerik:RadWindow ID="FabricanteForm" runat="server" Title="Fabricante del dispositivo"
                NavigateUrl="FabricanteForm.aspx" Height="300px" Width="350px" MaxHeight="768px"
                MaxWidth="1024px" KeepInScreenBounds="false" RestrictionZoneID="AreaVentanas">
            </telerik:RadWindow>
            ...
            <table style="width: 100%;">
                <tr>
                    <td class="alineadoDerecha">
                        ...
                        <img alt="logo" class="style1" longdesc="logo" src="images/logoTest.JPG" align="left"/>
