<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricanteGrid.aspx.cs" Inherits="FabricanteGrid" %>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newFabricante()
          {
              ...
              var url = "FabricanteForm.aspx?Caller=FabricanteGrid";
              var name = "FabricanteForm";
              openOutSide(url, name);
          }
          function editFabricante(id)
          {
              var url = "FabricanteForm.aspx?Caller=FabricanteGrid" + "&FabricanteId=" + id;
              var name = "FabricanteForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="FabricanteId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="FabricanteId" UniqueName="FabricanteId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newFabricante();" 
