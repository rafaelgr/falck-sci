            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                <div id ="Filtros">
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                <div id="Botons">
                                    <telerik:RadButton ID="btnInforme" runat="server" Text="Informe general" 
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" EnableLinqExpressions="false"
                        ...
                        <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="None"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="ModeloDispositivo.Nombre" 
                                                         FilterControlToolTip="Filtrar por modelo" FilterImageToolTip="Filtro"
                                                         HeaderText="Modelo" 
                                                         ReadOnly="True" 
                                                         SortExpression="ModeloDispositivo.Nombre" UniqueName="ModeloDispositivo.Nombre">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="Operativo" 
                                                         FilterControlToolTip="Filtrar por operatividad" FilterImageToolTip="Filtro"
                                                         HeaderText="Operativo"
                                                         ReadOnly="True" 
                                                         SortExpression="Operativo" UniqueName="Operativo">
                                </telerik:GridBoundColumn>
                ...
                <div id="Zona aviso">
                    <telerik:RadNotification ID="RadNotification1" runat="server" Text="El filtro ha sido agregado, lo puede ver en el desplegable" 
                                             ...
                                             TitleIcon="images/information_16.png" 
                                             EnableRoundedCorners="True" EnableShadow="True" 
                                             Height="400px" Position="Center" Title="INFORMACIÓN" 
                                             Width="400px">
