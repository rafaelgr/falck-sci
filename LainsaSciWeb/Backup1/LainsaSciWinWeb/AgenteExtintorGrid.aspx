<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgenteExtintorGrid.aspx.cs" Inherits="AgenteExtintorGrid" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>
      AgenteExtintors de dispositivos
    </title>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newAgenteExtintor()
          {
              //alert("newInstalacion");
              var url = "AgenteExtintorForm.aspx?Caller=AgenteExtintorGrid";
              var name = "AgenteExtintorForm";
              openOutSide(url, name);
          }
          function editAgenteExtintor(id)
          {
              var url = "AgenteExtintorForm.aspx?Caller=AgenteExtintorGrid" + "&AgenteExtintorId=" + id;
              var name = "AgenteExtintorForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="AgenteExtintorId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="AgenteExtintorId" UniqueName="AgenteExtintorId">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Descripcion" 
                                         FilterControlToolTip="Filtrar por agente extintor" FilterImageToolTip="Filtro"
                                         HeaderText="AgenteExtintor" 
                                         ReadOnly="True" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newAgenteExtintor();" 
